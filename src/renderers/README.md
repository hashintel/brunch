...
| Seed framing | `src/agents/contexts/seeds/origination.ts` | ◐ partial | Covered through colocated origination seed tests today; promote only if wording churn continues. |
