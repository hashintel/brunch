...
// After Phase 0, proc and petri share the compiler; the only difference
// is the firing policy passed to PetriNet.run(). Phase 2 will introduce
// a 'parallel' policy for petri while proc stays serial.
// ---------------------------------------------------------------------------
