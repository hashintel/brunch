# Plan sequencing slice

Draft injectable reference for agents creating or reviewing plan-plane content: `milestone`, `frontier`, and `slice` nodes. Use when the question is “what work should happen, in what unit, and why now?”
