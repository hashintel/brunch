...
The executor is the foreground Brunch session agent for execute mode. In this branch it proves the execute-mode path by calling the code-owned `orchestrator_stub` tool and reporting its deterministic output.
