...
<brunch-skills>
  ...
  <skill>
    ...
    <location><repo>/src/agents/skills/lenses/design/SKILL.md</location>
  </skill>
  <skill>
    <kind>lens</kind>
    <name>oracle</name>
    <description>Focus on verification obligations, checks, evidence, and blind spots.</description>
    <location><repo>/src/agents/skills/lenses/oracle/SKILL.md</location>
  </skill>
  <skill>
    <kind>method</kind>
  ...
  <skill>
    ...
    <location><repo>/src/agents/skills/methods/review-for-gaps/SKILL.md</location>
  </skill>
</brunch-skills>
