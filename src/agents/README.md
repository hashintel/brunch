...
The simplified elicitor lives under `runtime/elicitor/` and `contexts/live/`. The pre-D98 strategy/lens/method control system is being suspended under `runtime/suspended/`, `contexts/suspended/`, and `skills/suspended/` as callers are rewired.
