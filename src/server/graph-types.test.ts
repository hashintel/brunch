...
// src/server/graph-types.test.ts -> repo root
const packageRoot = dirname(dirname(dirname(fileURLToPath(import.meta.url))));
const typesPath = resolve(packageRoot, 'src/views/graph/types.ts');
const probePath = resolve(packageRoot, 'src/views/graph/__graph_types_probe__.ts');
...
describe('graph view types module', () => {
  it('exists at src/views/graph/types.ts as the root graph type module', () => {
