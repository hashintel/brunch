...
// src/client/components/graph/__tests__/graph-empty-state.test.ts -> repo root
const packageRoot = dirname(dirname(dirname(dirname(dirname(dirname(fileURLToPath(import.meta.url)))))));
const componentPath = resolve(packageRoot, 'src/client/components/graph/GraphEmptyState.tsx');
...
describe('GraphEmptyState module', () => {
  it('exists at src/client/components/graph/GraphEmptyState.tsx', () => {
