 ...
 *
 * Tested through the public surface only (`@/client/components/graph/graphStyle`); the assertions
 * survive any internal refactor of where the palette literally lives.
 */

import { describe, expect, it } from 'vitest';

import { nodeColor, nodeColorByKind } from '@/client/components/graph/graphStyle';
