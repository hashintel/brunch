...
function executableScopeGraph(lsn = 11): {
  ...
  return {
    ...
    edges: [
      ...
      { ...edgeBase, id: 4, category: 'dependency', sourceId: 12, targetId: 10 },
      { ...edgeBase, id: 5, category: 'dependency', sourceId: 10, targetId: 11 },
      { ...edgeBase, id: 6, category: 'witness', sourceId: 20, targetId: 10, stance: 'for' },
      { ...edgeBase, id: 7, category: 'witness', sourceId: 21, targetId: 11, stance: 'for' },
      { ...edgeBase, id: 8, category: 'composition', sourceId: 2, targetId: 30 },
      { ...edgeBase, id: 9, category: 'dependency', sourceId: 40, targetId: 2 },
    ],
  };
}
