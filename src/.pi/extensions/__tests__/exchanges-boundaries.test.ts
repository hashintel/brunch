...
const STRUCTURED_EXCHANGE_PROJECT = 'src/projections/exchanges';
...
const ACTIVE_PROJECTORS = new Set([
  'src/projections/exchanges/present-options.ts',
  'src/projections/exchanges/present-question.ts',
  'src/projections/exchanges/present-review-set.ts',
  'src/projections/exchanges/request-answer.ts',
  'src/projections/exchanges/request-choice.ts',
  'src/projections/exchanges/request-choices.ts',
  'src/projections/exchanges/request-review.ts',
]);
