...
export const PresentOptionsParams = Type.Object({
  exchangeId: Type.String({
    description:
      "Stable id tying this presented offer to the later request_* response.",
  }),
  heading: Type.String({ description: "Heading for the presented options." }),
  body: Type.Optional(
    Type.String({ description: "Markdown body shown before the options." }),
  ),
  ...
  expectedRequestTool: Type.Optional(
    Type.Union(
      [Type.Literal("request_choice"), Type.Literal("request_choices")],
      {
