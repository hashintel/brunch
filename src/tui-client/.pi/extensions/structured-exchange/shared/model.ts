export const STRUCTURED_EXCHANGE_PRESENT_SCHEMA =
  "brunch.structured_exchange.present" as const
export const STRUCTURED_EXCHANGE_REQUEST_SCHEMA =
  "brunch.structured_exchange.request" as const

export type PresentToolName = "present_question" | "present_options" | "present_review_set" | "present_candidates"
