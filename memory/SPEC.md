...
49. Each run gets worktree isolation at `<dir>/.cook/runs/<runId>/worktree/`; source repo stays untouched.
...
159. **Worktree isolation per run** — agents write freely inside `<dir>/.cook/runs/<runId>/worktree/`; source repo untouched. Depends on: Requirement 49.
...
| I123-K | Worktree isolation holds — source repo outside `<dir>/.cook/runs/<runId>/worktree/` is never mutated by an orchestrator run.                                                                                                                                                                                            | integration tests                                                                             | Requirement 49; D159-K                           |
...
| **worktree (orchestrator)**                | Isolated filesystem location where agents write during a run. Per-run; ephemeral.                                                                                                                                                                        |
