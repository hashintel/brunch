...
3. Extract a workspace-stream projector that maps durable workflow state, conversational turns, and anchored closure facts into ordered render artifacts while preserving current behavior.
