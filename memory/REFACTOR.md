...
2. Make pending digest reconstruction preserve the declared continuation question and add a local-versus-RPC terminal parity witness proving the durable question echo remains self-describing.
