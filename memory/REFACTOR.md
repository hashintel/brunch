...
2. Delete the self-fulfilling resource-invocation harness and retain only independently sourced expectations that the production characterization can falsify.
3. Delete the unused graph/lens seed renderer and its tests, and reconcile the owning seed topology and generated tree inventory in the same commit.
