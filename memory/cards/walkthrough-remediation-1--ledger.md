...
Build the first open required row whose gate is satisfied. Current next ready row: **WR7 · Seed insertion legibility after no-auth → post-login continuation diagnosis** (evidence-gated: run `ln-diagnose` first).
