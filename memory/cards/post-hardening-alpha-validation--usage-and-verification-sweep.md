...
| Stdio public RPC | `partial` | ● | `proving` | FE-1348; re-enter after the transcript-backed stdio trigger/projection path is accepted and repaired for a stopped same-workspace provider-authored ask, then authorize one new fresh target | `rpc.discover`, workspace/session activation, one read and one structured exchange through `npm run dev-cli -- rpc`; schemas, method results, JSONL, and projections agree without raw Pi RPC. Fresh same-workspace gate: public activation reopened the exact target as ready and state/runtime agreed, but the single `session.triggerExchange` returned idle while canonical JSONL remained byte-identical and ended in unresolved free-text ask `fe1348-anchor-1`; conduct stopped before pending/exchanges/submit with no retry or repair. Cost/value: repair would make the public compatibility projection usable across standalone-to-stdio composition; another unmodified attempt would only repeat the proved contradiction. This supersedes clone portability as the active gate while retaining that attempt as history. Evidence: [`stdio-public-rpc-fresh-target/walkthrough.md`](../../testing/walkthroughs/2026-08-10/stdio-public-rpc-fresh-target/walkthrough.md), [`testing/walkthroughs/2026-08-10/stdio-public-rpc-owned-gate.md`](../../testing/walkthroughs/2026-08-10/stdio-public-rpc-owned-gate.md), [`stdio-public-rpc-reentry/`](../../testing/walkthroughs/2026-08-10/stdio-public-rpc-reentry/). |
