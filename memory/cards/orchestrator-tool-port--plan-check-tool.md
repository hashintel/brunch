...
- `src/agents/runtime/elicitor/TOPOLOGY.md` and `src/agents/runtime/TOPOLOGY.md` — current runtime split; execute tool policy is not a live top-level runtime module yet, and new execute seams should stay in the live runtime tree.
