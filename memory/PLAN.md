...
- `petri-execution-parity` ([FE-1195](https://linear.app/hash/issue/FE-1195/petri-execution-parity-isolated-slice-fan-in-and-epic-integration)) — reopened on PR #325 after the live Petrinaut witness: restore timestamped firing compatibility, make verification verdict/failure identity structural, and project a compact deterministic viewer net. Scope: [`memory/cards/petri-execution-parity--petrinaut-live-parity.md`](cards/petri-execution-parity--petrinaut-live-parity.md).
...
- **Current execution pointer:** [`memory/cards/petri-execution-parity--petrinaut-live-parity.md`](cards/petri-execution-parity--petrinaut-live-parity.md) — timestamped wire, verdict topology, terminal evidence, and viewer projection.
