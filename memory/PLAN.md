...
- `exchange-ask-refinement` — one-shot ask terminal (D116-L) + exchange presentation refinement, on `ln/fe-1115-tui-refinements-1` (branch-per-category posture). Opened 2026-07-07 from grill + spec; definition below. Sliced execution: rich-body picker surface first (de-risks both halves), standalone ask cutover second, offer declared-continuations third.
...
- **Linear:** to be created (FE team, brunch project) — no parent issue
