...
- **Kind:** structural
- **Status:** active — **slice 1 done** (executability contract + repair + `Toolchain` descriptor landed + unit-tested 2026-06-09); **slice 2 (toolchain-agnostic cook prompts + runner) next**. SPEC records A100-K (partially-validated), D167-K (+ base/emitted profile-split refinement), I129-K, Future Direction §Cook plan generation.
