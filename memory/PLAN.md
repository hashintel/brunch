...
- **Current execution pointer:** [`memory/cards/executor-plan-synthesis--planning-projection-contract.md`](cards/executor-plan-synthesis--planning-projection-contract.md) (Slice A, two cards; folded design-permutations record).
