...
- **Current execution pointer:** inline streaming landed (ThreadCollapsible accepts user input, streams assistant responses via SSE, persists turns). Next slice: `SideChatPopover` retirement cutover — route side-chat interactions through the inline ThreadCollapsible instead of the popover.
