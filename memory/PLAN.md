...
- **Next action:** build the active D119-L [`Continue lexical closure`](cards/walkthrough-remediation-2--continue-lexical-closure.md) sweep. Its inventory is closed over current product-controlled UI/control copy, orientation ids/results, prompt resources, tests, and canonical current-state records; historical/archive material remains provenance, not rewrite scope.
