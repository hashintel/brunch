...
- **Certainty:** proving.
- **Current execution pointer:** next slice should begin the first executable-plan schema seam; do not create cook runs/worktrees yet.
...
- **Acceptance:**
  ...
  - Next: first executable-plan schema seam.
