...
- **Live scope files:** none. Companion React convergence landed 2026-08-07; the structured-ask, rival-refusal, and shutdown/reopen slices are the next scoping candidates and stay unscoped until `ln-scope` runs.
