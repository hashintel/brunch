...
active:
  shared-session-host-tracer (FE-1321)
    ...
    next: build slice 2 of memory/cards/shared-session-host-tracer--authority-transfer.md —
          standalone-web takeover of the released target, appended to the same PTY journey
          in session-runtime-contract-authority.slow.test.ts
