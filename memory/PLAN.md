...
edges:
  ...
  renderer-golden-coverage  -[tripwire]->     prompt-composition-golden-coverage  (only the deferred full-stack real-rendered-context golden waits on renderer stability)
