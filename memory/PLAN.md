...
- **Current execution pointer:** Web mode HTTP shell and WebSocket JSON-RPC bridge are complete; next slice adds the native React workspace snapshot shell over the WebSocket client.
