...
- 2026-07-14 `petri-execution-parity` (FE-1195) — completed the old-`main` live-parity closure: timestamped firing wire, structural pass/fail branches with complete failed-slice terminal evidence, stale serial-state retirement at parallel admission, journal-idempotent restart-stable terminal authority, causality-gated Petrinaut replay/export, and a view-only projection with mechanically pruned isolated places, preserved connected IDs/arcs, contextual labels, and compact deterministic execution bands. Durable terminal evidence wins over later abandonment metadata; raw executor topology/markings and SSE firing order remain unchanged. Manual Rust fixture comparison remains pre-PR outer evidence.
...
- `petri-execution-parity` ([FE-1195](https://linear.app/hash/issue/FE-1195/petri-execution-parity-isolated-slice-fan-in-and-epic-integration)) — ✓ built 2026-07-14; timestamped firing compatibility, structural verification verdict/failure identity, and the compact deterministic Petrinaut viewer projection are closed. Manual Rust fixture/Petrinaut comparison remains pre-PR outer evidence. Scope: [`memory/cards/petri-execution-parity--petrinaut-live-parity.md`](cards/petri-execution-parity--petrinaut-live-parity.md).
