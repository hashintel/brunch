...
- **Status:** picked up 2026-07-13; scoped — restack onto FE-1187's landed auth reversal before build so run D witnesses the corrected surface
- **Current execution pointer:** [`memory/cards/spec-posture--establishment-tracer.md`](cards/spec-posture--establishment-tracer.md)
