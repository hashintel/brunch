...
- `petri-execution-parity` ([FE-1195](https://linear.app/hash/issue/FE-1195/complete-petri-execution-parity)) — ✓ built + review-hardened 2026-07-14; timestamped firing compatibility, structural verification verdict/failure identity, journal-idempotent terminal replay, collision-free locale-independent viewer layout, strict staging definition parity, and the tightened `execute.run` replay contract are closed without changing raw executor topology, marking authority, or firing order. Manual Rust fixture/Petrinaut comparison remains the final outer check after PR #329 restacks.
...
- **Status:** ✓ review-clean and fully gated 2026-07-14; `npm run verify` passes (2,145 tests passed, 2 existing skipped). Manual Rust fixture/Petrinaut comparison follows after PR #329 restacks.
