...
- **Current execution pointer:** `memory/cards/main-editor-chrome--persistent-editor-tracer.md` — first slice for thread 1 (`BrunchEditorComponent` via `ctx.ui.setEditorComponent`, render-height assumption, headless guard, border-semantics seam).
