...
- **Aggregate DoD:** WR1–WR8 remain built; no required WR13–WR18 row remains open; D120-L/I60-L are materialized in topology/code; every WR18 O1–O10 obligation reaches the ledger's allowed terminal state with evidence in `TESTING_FINDINGS.md`; any failure has an explicit promoted owner and PLAN disposition.
