...
- `exchange-ask-refinement` ([FE-1164](https://linear.app/hash/issue/FE-1164/one-shot-ask-terminal-and-exchange-presentation-refinement)) — **done 2026-07-08 after review-fix pass**: skipped exchange suites are un-skipped, ask collection is declaration-driven, fallback rungs restored, and the Pi legacy present-question/request-response adapter cluster is deleted. Branch `ln/fe-1164-ask-terminal`. Definition below.
...
- **Current execution pointer:** none — all cards plus the 2026-07-08 review-fix slice are built; scope files retired.
