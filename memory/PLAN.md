...
- **Current execution pointer:** slices A and B consumed (scope files deleted); scope slice C (PR #325 composition witness + live Specify→scope→plan→execute→promotion witness) next via `ln-scope`.
