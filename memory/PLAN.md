...
- **Status:** implementation complete on draft PR #322; pre-execution SDCPN/journal preparation, subscribe-before-snapshot catch-up, replay-equivalent same-connection terminal delivery, and host-shutdown cleanup are covered by executor and real HTTP lifecycle tests. `npm run verify` passed; review/merge pending.
