...
- **Current execution pointer:** `memory/cards/component-dx--preview-theme-toggle.md` (TUI-refinement lane on `ln/fe-1115-tui-refinements-1`; Cards 1–3 done — theme toggle, `matchesKey` sweep, hot-reload + testbed feedback loop — Card 4 in flight: theme value rework, JSONs uncommitted while the user iterates).
