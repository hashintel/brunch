...
**Merge wave (2026-07-08) + plan consolidation.** The braided ship-gate stack and the KA executor lanes are merged to `next`: FE-1122/#286, FE-1123/#287, FE-1124/#288, FE-1134/#289, FE-1135/#291, FE-1136/#292, FE-1137/#290, FE-1138/#293, FE-1152/#294, and KA's FE-1141/#295, FE-1154/#297, FE-1155/#296, FE-1107/#298. Still open: FE-1159 (#299), FE-1115 (#301), FE-1164 (unsubmitted), and KA's #300/#302/#303. A same-day `ln-plan` hygiene pass batched all straggling outer-loop residue from the merged lanes into one frontier (`walkthrough-evidence-batch`, FE-1167), pruned non-frontier Horizon rows, and folded `blank-carrier-sweep` into the FE-1163 ledger.
...
- `exchange-ask-refinement` (FE-1164) — built + review-verified 2026-07-08; branch `ln/fe-1164-ask-terminal` awaiting `gt submit` + tie-off (stacked on FE-1115 #301). See Recently Completed; definition below (kept live: `headless-ask-discovery` and `review-commentary-widening` build on it).
