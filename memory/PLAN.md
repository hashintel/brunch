...
- **Current execution pointer:** none — persistent-editor tracer consumed 2026-07-08 (`BrunchEditorComponent` via `ctx.ui.setEditorComponent`, render-height assumption, headless guard). Scope the next main-editor-chrome thread before building.
