...
- `standalone-web-session-host` (FE-1200) — **presentation-coverage sweep closing B2** (retires I65-L breadth). Ledger: [`memory/cards/standalone-web-session-host--presentation-coverage.md`](cards/standalone-web-session-host--presentation-coverage.md). A2–A5, B1, and B3 are built; B2 is rescoped inside FE-1200 at [`memory/cards/standalone-web-session-host--review-receipt-presentation.md`](cards/standalone-web-session-host--review-receipt-presentation.md).
...
- **Current execution pointer:** B2 closure is prepared at [`memory/cards/standalone-web-session-host--review-receipt-presentation.md`](cards/standalone-web-session-host--review-receipt-presentation.md): first persist the canonical committed receipt in validated `request_review` details, then project/render the review set and receipt. The sweep ledger remains open until both slices land and B2 is built.
