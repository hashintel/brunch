...
- `main-editor-chrome` (FE-1169) — chrome-batch opener, in heavy flight: builder commits landed 2026-07-08 for threads 1–5 (ask surface, mode-reactive chrome, commands, startup theming, and details-driven candidate rendering); the first-wave judo fix cards consumed; roving-flake stabilization rode this branch. Remaining cards: `--ask-judo-consolidation.md` + `--review-contract-followups.md` (judo review #2, 2026-07-08 — land the ask card before any further ask-surface slice), `--theme-demo-expansion.md`, then outer manual beats. Branch `ln/fe-1169-editor-chrome` (PR #305; parents merged — `gt restack` onto `next` owed). Definition below.
...
frontiers:
  Active:
    ...
    main-editor-chrome (FE-1169)
      status: in flight — threads 1/2/3/4 + D1/D2/D3/D4 + first-wave judo fixes landed 2026-07-08;
              remaining: ask-judo-consolidation, review-contract-followups, theme demo, outer beats
