...
- **Next action:** build Card 4 of the active four-card [`deterministic remediation queue`](cards/walkthrough-remediation-2--deterministic-remediation-queue.md): the deterministic full Ask matrix. Cards 1–3 are complete; historical/archive material remains provenance, not rewrite scope.
