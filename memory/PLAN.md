...
- **Status:** in-progress (command-containment, dynamic chrome, workspace-dialog startup flow, in-session workspace command, pty startup oracle, centered branded overlay reuse, and evidence-memo reconciliation have landed; current missing seam is the structured-question / RPC-relay loop)
