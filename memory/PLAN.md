...
- `petri-execution-parity` ([FE-1195](https://linear.app/hash/issue/FE-1195/petri-execution-parity-isolated-slice-fan-in-and-epic-integration)) — final review closure is complete on PR #325: dispatch parity is journal-carrier-independent, transition comparison is topology-replayed, and preparation cannot recreate a lost journal. Scope/evidence: [`memory/cards/petri-execution-parity--review-remediation.md`](cards/petri-execution-parity--review-remediation.md).
