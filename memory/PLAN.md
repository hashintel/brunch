...
- **Next action:** build Card 3 of the active four-card [`deterministic remediation queue`](cards/walkthrough-remediation-2--deterministic-remediation-queue.md): deterministic orientation rendering/fallback, then the deterministic Ask matrix. Cards 1–2 are complete; historical/archive material remains provenance, not rewrite scope.
