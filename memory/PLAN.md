...
- **Current execution pointer:** `memory/cards/exchange-ask-refinement--witness-gap-closure.md` (2 slices: ask runtime-mount battery, candidates supersession probe) — verification closure from the 2026-07-08 witness audit, landing before tie-off.
