...
- **Current execution pointer:** `memory/cards/component-dx--preview-theme-toggle.md` (TUI-refinement lane on `ln/fe-1115-tui-refinements-1`; Card 1 = live dark/light theme toggle in the preview gallery, further refinement cards appended there as they become legible).
