...
- **Traceability:** D112-L (set-returning scheduler + `frontierFiringPolicy`), D123-L (bounded durable parallel slice authority), D124-L (same-process run admission + epic effect claims), FE-1166 substrate/verify policy, `docs/praxis/worktree-agents.md`, `src/executor/TOPOLOGY.md`.
