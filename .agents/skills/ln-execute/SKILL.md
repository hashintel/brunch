---
name: ln-execute
description: "Run one execution focus — a PLAN frontier, active scope files, memory/REFACTOR.md, or a named concern — through delegated ln-scoper/ln-builder agents, reviewing each unit independently. Use only when the user explicitly asks to execute a block of work through delegation."
